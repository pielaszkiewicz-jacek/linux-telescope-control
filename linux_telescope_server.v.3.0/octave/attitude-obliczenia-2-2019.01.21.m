...
function retval = build_Q11( Z, sigma, B, eta )
  ...
  p1 = ( transpose( Z ) * Z + sigma ^ 2 - trace( B * transpose( B ) ) ) * eye( 3 )
...
function retval = build_K_n1_n( K, FI )
  retval = FI * K * transpose( FI )
endfunction
