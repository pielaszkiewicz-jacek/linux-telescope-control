...
mes2 = buildMeasurment( rotM, mes1(7, size) + dT, dT, size, [ 11, 03, 43.41 ], [ 61, 45, 06.400, 0 ] )
# Aldebaran (3)
mes3 = buildMeasurment( rotM, mes2(7, size) + dT, dT, size, [ 11, 53, 50.09 ], [ 53, 41, 41.490, 0 ] )
mes3 = buildMeasurment( rotM, mes2(7, size) + dT, dT, size, [ 11, 03, 43.41 ], [ 61, 45, 06.400, 0 ] )
#
# 0. Wartosci globalne
#
w       = 1.0 / 6.0
...
B_0       = build_B( ref, obs, w ) + build_B( ref2, obs2, w )
...
omega = [0.0000077267, -0.0000055733, 0.0000297700]
...
B_k1       = build_B( ref_k1, obs_k1, w ) + build_B( ref_k12, obs_k12, w  )

S_k1       = build_S( B_k1 )
Z_k1       = build_Z( w, obs_k1, ref_k1 )
Z_k1 = [	B_k1(2, 3) - B_k1(3, 2),
			B_k1(3, 1) - B_k1(1, 3),
			B_k1(1, 2) - B_k1(2, 1)]
