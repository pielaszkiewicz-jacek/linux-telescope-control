#ifndef __tlinsTimeTransaltion_hpp__
#define __tlinsTimeTransaltion_hpp__

class tlinsTimeTransaltion {
};
...
int fun()
{
	...
	double slatn, slonw, hm, elon, phi, xyz[2], u, v, sec, utc1, utc2, dut, ut11, ut12, ut, tai1, tai2, tt1, tt2, tcg1,
	    tcg2, dtr, tdb1, tdb2, tcb1, tcb2;
